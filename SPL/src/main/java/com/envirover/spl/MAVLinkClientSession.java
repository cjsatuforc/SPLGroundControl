 ...
 *
 */
public class MAVLinkClientSession implements ClientSession {

    private final static Logger logger = Logger.getLogger(MAVLinkClientSession.class);
    ...
    public MAVLinkClientSession(MAVLinkChannel src, MAVLinkChannel mtMessageQueue) {
        this.src = src;
        this.dst = mtMessageQueue;
    }

    /* (non-Javadoc)
     * @see com.envirover.spl.ClientSession#onOpen()
     */
    @Override
    public void onOpen() {
    ...
    /* (non-Javadoc)
     * @see com.envirover.spl.ClientSession#onClose()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.envirover.spl.ClientSession#onMessage(com.MAVLink.MAVLinkPacket)
     */
    @Override
